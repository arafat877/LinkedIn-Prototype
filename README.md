This project is intended to create an HTML/CSS slicing for ModalRakyat coding test. This project uses ReactJS 16 with Bootstrap 4 Framework. To run this project, follow these steps.
